...
- [x] **Modal Upgrade dédié** : `UpgradeDialog` (3 plans, recommandé) monté global (`AppShell`) via `useUpgradeStore` ; CTA Pro = checkout Stripe direct ; tous les CTA recâblés (profil/switcher/members/analytics). **Enrichi des crédits IA** par plan (FREE 100k / PRO 1M / ENTERPRISE illimité tokens Cortex) — cohérent avec le quota par compte. [id:: FE-SUB-010] [statut:: done] [parite:: extra] [ref:: frontend/components/subscription/upgrade-dialog.tsx] (QA2-19, maj 12/07/2026)
