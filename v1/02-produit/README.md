...
- **Site (25/09/2026) :** hero repositionné sur les agents de code (24/09), passe de polish (hero scindé + runs live par rôle, titres révélés au scroll, metas SEO), puis runner local présenté en accès anticipé et bloc Enterprise sur un écran (home ≈ 10 écrans) : produit **v0.40.0**. Détail : [Landing](./Landing.md) LP-HERO-001, LP-HOME-001, LP-RUNNER-001.
