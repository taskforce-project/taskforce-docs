...
- **Site (25/09/2026) :** hero repositionné sur les agents de code (24/09) puis passe de polish (hero scindé + runs live par rôle, home à 11 écrans, titres révélés au scroll, metas SEO) : en prod `landing-v1.2.0` / produit **v0.39.0**. Détail : [Landing](./Landing.md) LP-HERO-001, LP-HOME-001.
