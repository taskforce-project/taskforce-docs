...
Pour les diagrammes détaillés et la modélisation complète avec les dépendances entre les lots, se référer au [CdCF](./01_CdCF.md) et aux diagrammes dans le dossier [assets/diagrammes](../../projet/assets/diagrammes).
